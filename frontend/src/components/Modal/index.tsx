export const Modal = ({title, children, closeModal, show}) => {
    return (
        <div tabIndex="-1" aria-hidden="true" className={`${show ? "" : "hidden"}  overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 p-4 md:inset-0 h-modal md:h-full`}>
